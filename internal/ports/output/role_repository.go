...
type RoleRepository interface {
	...
	// Используется в write-сценариях внутри транзакции, где операция зависит от
	// текущего состояния роли и её связей.
	FindByCodeForUpdate(ctx context.Context, code string) (*entity.Role, error)
